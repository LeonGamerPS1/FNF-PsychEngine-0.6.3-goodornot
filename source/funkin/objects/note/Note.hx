...
class Note extends FlxSprite
{
	...
	{
		if (isSustainNote && animation.name.indexOf("end") == -1)
		{
			var susheight = getSusHeight(speed);
			if (height != susheight)
			{
				scale.y = susheight / frameHeight;
				updateHitbox();
			}
			height = susheight;
		}
	...
	public function getSusHeight(speed:Float)
	{
		return sustainLength * speed;
	}
