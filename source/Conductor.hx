...
class Conductor
{
	...
	public static var ogSFO = (ClientPrefs.safeFrames / 60) * 1000;
	public static var safeZoneOffset(get,null):Float = (ClientPrefs.safeFrames / 60) * 1000; // is calculated in create(), is safeFrames in milliseconds

	static function get_safeZoneOffset():Float {
		return ogSFO / FlxG.timeScale;
	}
